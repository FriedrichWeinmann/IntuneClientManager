...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\IntuneClientManager\functions", "$global:testroot\..\IntuneClientManager\internal\functions"),
	
	[string]
	$ModuleName = "IntuneClientManager",
...
$CommandPath = @(
    "$global:testroot\..\IntuneClientManager\functions"
    "$global:testroot\..\IntuneClientManager\internal\functions"
)
