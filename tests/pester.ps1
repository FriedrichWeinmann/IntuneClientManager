...
Remove-Module IntuneClientManager -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\IntuneClientManager\IntuneClientManager.psd1"
Import-Module "$PSScriptRoot\..\IntuneClientManager\IntuneClientManager.psm1" -Force
